...
INSERT INTO "new_Game" ("createdAt", "id", "initialPoints", "playerCount", "returnPoints", "status") SELECT "createdAt", "id", "initialPoints", "playerCount", "returnPoints", "status" FROM "Game";
DROP TABLE "Game";
